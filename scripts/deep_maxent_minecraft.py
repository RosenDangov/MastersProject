...
def main(grid_size, discount, n_objects, n_colours, n_trajectories, epochs,
    ...
    # print 1,(feature_matrix.shape[1],) +structure
    # print 2,feature_matrix
    # print 3,ow.n_actions
    # print 4,discount
    # print 5,ow.transition_probability
    print 6,trajectories
    # print 7,epochs
    # print 8,learning_rate
    # print 9,l1,l2
...
if __name__ == '__main__':
    main(10, 0.9, 15, 1, 20, 100, 0.9, (3, 3))
